...
function submit() { form.put(route('servicios.update', props.servicio.id)) }
</script>
...
<template>
    ...
    <div class="max-w-md mx-auto mt-10 bg-white shadow rounded px-8 py-6">
        <h2 class="text-xl font-bold mb-6">Editar Servicio</h2>
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('servicios.index')" class="text-gray-700 underline ml-4">Cancelar</Link>
            </div>
        </form>
    </div>
    <footer
