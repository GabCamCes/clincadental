...
const props = defineProps({ especialidades: Array })
const form = useForm({
    ci: '', nombres: '', apellido_paterno: '', apellido_materno: '', telefono: '',
    correo: '', edad: '', genero: '', password: '', especialidad_id: ''
})
function submit() { form.post(route('medicos.store')) }
</script>
...
<template>
    ...
    <div class="max-w-md mx-auto mt-10 bg-white shadow rounded px-8 py-6">
        <h2 class="text-xl font-bold mb-6">Nuevo Médico</h2>
