...
<template>
    ...
    <div class="max-w-5xl mx-auto mt-10">
        ...
        <table v-else-if="productos && productos.data && productos.data.length > 0" class="w-full bg-white dark:bg-slate-800 rounded shadow mb-6">
            <thead>
            ...
            <tbody>
                <tr v-for="producto in productos.data" :key="producto.id" class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-2 px-3 text-center flex gap-2 justify-center">
                        <Link :href="route('productos.edit', producto.id)" class="btn btn-edit">Editar</Link>
